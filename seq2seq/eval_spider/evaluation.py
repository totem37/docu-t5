...
class Evaluator:
    ...
    def evaluate_one(self, db_name, gold, predicted, turn_scores, idx, instance_index):
        ...
        if self.etype in ["all", "match"]:
            ...
            # print all queries
            print("{} {} pred: {}".format(instance_index, hardness, predicted))
            print("{} {} gold: {}".format(instance_index, hardness, gold))
            print("")
...
def evaluate(
    ...
    for i, (p, g) in enumerate(zip(plist, glist)):
        ...
        for idx, pg in enumerate(zip(p, g)):
            ...
            g_str, db_name = g
            eval_one_result = evaluator.evaluate_one(db_name, g_str, p_str, turn_scores, idx, idx)
            results.append(eval_one_result)
            failures.append(eval_one_result.get('predictSQL'))
