...
_DESCRIPTION = """\
    Spider-Dates: new temporal data based on the original Spider dataset.
"""
...
_URL = "https://drive.google.com/uc?export=download&id=1Vi3VX7tp9rClYZS3_VDNVH_yZzf5bVeg&confirm=t"

class SpiderDates(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager) -> List[datasets.SplitGenerator]:
        ...
        return [
            ...
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepaths":[downloaded_filepath + "/spider-dates/dev_spider_dates.json"],
                    "db_path": downloaded_filepath + "/spider-dates/database",
                },
            ),
        ]
