...
_DESCRIPTION = """\
    DK-Spider-Dates: new temporal data based on the original Spider & Spider-DK datasets.
"""
...
_URL = "https://drive.google.com/uc?export=download&id=10xtuwzWJn_7SfOi7xnXjXTF9B3oz6zdO&confirm=t"

class DKSpiderDates(datasets.GeneratorBasedBuilder):
    VERSION = datasets.Version("1.0.0")

    BUILDER_CONFIGS = [datasets.BuilderConfig(
        name = "dk-spider-dates",
        version = VERSION,
    ...
    def _split_generators(self, dl_manager) -> List[datasets.SplitGenerator]:
        ...
        return [
            datasets.SplitGenerator(
                ...
                gen_kwargs={
                    "data_filepaths":[downloaded_filepath + "/dk-spider-dates/dk_spider_dates.json"],
